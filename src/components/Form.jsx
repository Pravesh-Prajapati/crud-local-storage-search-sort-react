...
function Form() {
    ...
    let update = (pos) => {
        ...
        console.log(updata[0].hobbies);
        setdata(updata[0])
        setHob(updata[0].hobbies)
    }
    // ========================================================search===
    let searchingdata = (e) => {
    ...
    let sortby = (type) => {
        ...
        if (type == "fname" && res == true) {
            newlist.sort((a, b) => a.fname.localeCompare(b.fname))
            setres(false)
        }
        else if (type == "email" && res == true) {
            newlist.sort((a, b) => a.fname.localeCompare(b.fname))
            setres(false)
        }
        else {
    ...
    return (
        <>
            ...
            <div className="container-wl">
                ...
                <input type="text" placeholder='search by first name' style={{ marginBottom: "10px", padding: "10px" }} onChange={(e) => { searchingdata(e) }} />
                ...
                <table>
                    <tr className='rows'>
                        <th>First Name
                            ...
                            <button className='btn3' onClick={() => { sortby("fname"); setres(!res) }}><LuArrowDownUp /></button>
                        </th>
                        <th>
                            Last Name
                        </th>
                        <th>
                            Email
                            <button className='btn3' onClick={() => { sortby("email"); setres(!res) }}><LuArrowDownUp /></button>
                        </th>
                        <th>
                            Phone
                                ...
                                return (
                                    <>
                                        <tr className='table-data' key={i}>
                                            ...
                                            <td>{val.city}</td>
                                            <td>{val.gender}</td>
                                            <td style={{ display: "flex", gap: "5px", textAlign:"center", margin:"0 auto", paddingRight: "0px" }}>
                                                <div className='hobby'>
                                                    {val.hobbies.map((val) => {
                                                        return (
                                                            <>
                                                                <h5 className='vals'>{val}</h5>
                                                            </>
                                                        )
                                                    })
